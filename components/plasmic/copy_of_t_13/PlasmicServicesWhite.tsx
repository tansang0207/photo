...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: g7g-r5EhuI6U/css

import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: XTQkrDZyskjD/icon
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__u3Bf2)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__yIJuS)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fySma)}
      >
        <h3

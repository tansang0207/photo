...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: RMVcfBDac8Qb/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__sfrOn)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/copy_of_t_13/images/people31046351920Jpg.jpg",
              fullWidth: 1920,
              fullHeight: 1281,
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button__gIxpD)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
